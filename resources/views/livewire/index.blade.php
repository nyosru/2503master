             ...
             mx-auto flex flex-col justify-center"
                ...
                ">
                        ...
                        <div class="p-2 w-full flex flex-row hover:bg-yellow-200">
                            ...
                            <div class="p-2 w-1/2">
                                <a href="{{ route('go-to-test.ruk') }}" class="bg-blue-300 rounded px-3 py-1">Войти как
                                    руководитель</a>
                                <br/>
                                <a href="{{ route('go-to-test.manager') }}" class="bg-blue-300 rounded px-3 py-1">Войти
                                    как
                                    работник 1</a>
                                <Br/>
                                <a href="{{ route('go-to-test.manager') }}" class="bg-blue-300 rounded px-3 py-1">Войти
                    ...
                    @if(1==2)
                        <div class="p-2 w-full flex flex-row hover:bg-yellow-200">
                            <div class="w-1/2 flex items-center">
                                <img src="/icon/team-full.webp" class="h-[80px] mr-2 float-left rounded-full"
                                     alt="team1">
                                Организация ( руководитель процесса и исполнитель(и) которые передают заказ друг другу,
                                один
...
{{--                    bg-yellow-300 --}}
    ...
    @if(1==2)
        <nav class="bg-white shadow-md py-4">
            <div class="container mx-auto px-4 flex justify-between items-center">
                ...
                <div>
                    <a href="#"
                       class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-lg font-medium transition duration-300">Войти</a>
                </div>
            </div>
        </nav>
    @endif
    ...
    inline-flex items-center"
            ...
            <div class="md:w-1/2 flex justify-center">
                <div class="relative w-full max-w-lg">
                    ...
                    <div
                        class="absolute -bottom-6 -right-6 w-64 h-64 bg-purple-200 rounded-lg opacity-50 animate-pulse delay-500"></div>
    ...
    <section class="bg-white p-4">
        Канбан (яп. 看板 — «вывеска, сигнал») — это методика управления проектами и рабочими процессами, основанная на принципах «точно в срок» и бережливого производства. Она использует визуальные инструменты, такие как Канбан-доска с карточками задач, чтобы сделать рабочий процесс наглядным, ограничить незавершенную работу и повысить эффективность.
    </section>
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4">
            ...
            <p class="text-gray-600 text-center max-w-2xl mx-auto mb-12">Наша CRM-система предоставляет все необходимое
                для эффективного управления лидами и повышения конверсии</p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-gray-50 p-6 rounded-lg border border-gray-200 hover:shadow-md transition duration-300">
                    ...
                    <p class="text-gray-600">Создавайте неограниченное количество досок с настраиваемыми колонками под
                        ваши бизнес-процессы.</p>
                </div>
                ...
                <div class="bg-gray-50 p-6 rounded-lg border border-gray-200 hover:shadow-md transition duration-300">
                    ...
                    <p class="text-gray-600">Назначайте права доступа сотрудникам, контролируйте кто что видит и
                        редактирует.</p>
                </div>
                ...
                <div class="bg-gray-50 p-6 rounded-lg border border-gray-200 hover:shadow-md transition duration-300">
                    <div
                        class="bg-purple-100 w-14 h-14 rounded-lg flex items-center justify-center text-purple-600 mb-4">
                        <i class="fas fa-arrows-alt text-2xl"></i>
                    </div>
                    <h3 class="font-bold text-xl mb-3">Перетаскивание карточек</h3>
                    <p class="text-gray-600">Интуитивное перемещение карточек между колонками для визуального
                ...
                <div class="bg-gray-50 p-6 rounded-lg border border-gray-200 hover:shadow-md transition duration-300">
                    <div
                        class="bg-yellow-100 w-14 h-14 rounded-lg flex items-center justify-center text-yellow-600 mb-4">
                        <i class="fas fa-bell text-2xl"></i>
                    </div>
                    <h3 class="font-bold text-xl mb-3">Уведомления</h3>
                    <p class="text-gray-600">Получайте уведомления об изменениях, назначениях и приближающихся
                        дедлайнах.</p>
                </div>
                ...
                <div class="bg-gray-50 p-6 rounded-lg border border-gray-200 hover:shadow-md transition duration-300">
                    ...
                    <p class="text-gray-600">Отслеживайте эффективность вашей команды с помощью встроенных отчетов и
                        аналитики.</p>
                </div>
                ...
                <div class="bg-gray-50 p-6 rounded-lg border border-gray-200 hover:shadow-md transition duration-300">
                    <div
                        class="bg-indigo-100 w-14 h-14 rounded-lg flex items-center justify-center text-indigo-600 mb-4">
                        <i class="fas fa-mobile-alt text-2xl"></i>
                    </div>
                    <h3 class="font-bold text-xl mb-3">Мобильное приложение</h3>
                    <p class="text-gray-600">Работайте с вашими лидами где угодно с помощью мобильного приложения для
                        iOS и Android.</p>
                </div>
            </div>
        </div>
    ...
    <section class="py-16 bg-gradient-to-r from-blue-600 to-indigo-700 text-white rounded-lg">
        <div class="container mx-auto px-4 text-center">
            ...
            <p class="text-blue-100 max-w-2xl mx-auto mb-10">Присоединяйтесь к десяткам компаний (и ИП), которые уже
                используют ПроцессМастер
