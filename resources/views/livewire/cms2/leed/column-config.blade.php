            ...
            <div class="bg-white p-6 rounded-lg shadow-lg w-1/2 md:w-1/3">
                ...
                <form wire:submit.prevent="saveColumnConfig">
                    ...
                    <div class="flex flex-col space-x-3 text-sm font-medium">
                        ...
                        @foreach ($settings as $key => $value)
                            <div class="flex flex-row mb-2 space-x-2">
                                ...
                                <div class="w-1/4">
                                    <input type="checkbox" wire:model="settings.{{ $key }}" @if($value) checked @endif />
                                </div>
                            </div>
                        @endforeach
                    ...
                    <div class="text-center mt-4">
                        <button type="button" wire:click="$set('modal_show', false)" class="bg-gray-500 text-white py-1 px-4 rounded mr-2">
                            Закрыть
                        </button>
